...
-- Update existing profiles with email from auth.users (requires superuser or service role)
-- Note: This might not work directly in SQL Editor if permissions are restricted, 
-- but usually works for the project owner.
